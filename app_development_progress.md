...
* Started working on app again in January of this year. Instead of only building backend first, I worked on making the gui as well to be able to test things. I currently have a working version!
* Successfully built base of app, with entries, sections, stats, gear, email export, and even added map feature. 


### 2026 Eventual TODOs
* Have entries prefill based on last one
* Allow users to add photos to entries
* Longest hike needs to show the distance
* Allow users to import previous hikes
